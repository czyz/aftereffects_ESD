...
// // PANEL2
// // ======
// var panel2 = ExportToStableDiffusion.add("panel", undefined, undefined, {name: "panel2"}); 
//     panel2.text = "Output Format"; 
...
// var OutputFormats_array = ["Item 1","-","Item 2"]; 
// var OutputFormats = panel2.add("dropdownlist", undefined, undefined, {name: "OutputFormats", items: OutputFormats_array}); 
//     OutputFormats.selection = 0; 
//     OutputFormats.alignment = ["fill","top"]; 
...
ESRGAN_StrengthText.onChanging = function() {
    ESRGAN_Strength.value = Number (ESRGAN_StrengthText.text);
}
...
GFPGAN_StrengthText.onChanging = function() {
    GFPGAN_Strength.value = Number (GFPGAN_StrengthText.text);
}
